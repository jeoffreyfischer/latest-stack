...
export interface Stack {
  ...
  versionSource?: 'gcp' | 'java' | 'python' | 'go' | 'ruby' | 'php' | 'aws' | 'postgresql' | 'mongodb' | 'mysql' | 'django' | 'elixir' | 'dart' | 'sqlite' | 'expo' | 'gitlab-runner' | 'r' | 'visualstudio' | 'cursor' | 'qwik' | 'phoenix' | 'alpinejs' | 'htmx' | 'apollo-server' | 'graphql' | 'deno' | 'corepack' | 'opensearch' | 'dynamodb' | 'junit' | 'nix' | 'talos' | 'http' | 'tls' | 'oauth' | 'json-schema'
